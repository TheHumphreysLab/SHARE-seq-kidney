...
for i in adata.obs['celltype_2023']:
    if i in ['DCT','CNT','PC1','PC2']:
        dis_use.append(1)
    else:
        dis_use.append(0)
adata.obs['dis_use']=dis_use
adata2 = adata[adata.obs.dis_use == 1, :]
...
#a strict QC is necessary
sc.pp.neighbors(adata3, n_neighbors=20,n_pcs=20)
